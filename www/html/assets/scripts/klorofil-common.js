$(document).ready(function () {
    ...
    $('.time-right .time-btn-toggle').clickToggle(
        function (e) {
            e.preventDefault();

            // if has scroll
            if ($(this).parents('.data-times').find('.time-lists').length > 0) {
                affectedElement = $('.time-lists');
            }

            $(this).parents('.data-times').find('.time-lists').slideUp(300);
            $(this).find('i.lnr-chevron-up').toggleClass('lnr-chevron-down');
        },
        function (e) {
            e.preventDefault();
            ...
            $(this).parents('.data-times').find('.time-lists').slideDown(300);
            $(this).find('i.lnr-chevron-up').toggleClass('lnr-chevron-down');
        }
    );
